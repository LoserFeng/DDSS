...
attack_src_ip_arr=["10.0.3.32","10.0.3.31","10.0.3.31","10.0.4.41","10.0.4.42","10.0.4.42","10.0.4.41"]

attack_dst_ip_arr=["10.0.9.1","10.0.9.1","10.0.1.11","10.0.1.11","10.0.1.12","10.0.2.21","10.0.2.21"]
...
for i in range(len(ipsrcList[0])):
    for j in range(len(attack_dst_ip_arr)):
        print("\n")
        print(ipsrcList[0][i])
        print(attack_src_ip_arr[j])
        time.sleep(0.5)
        if(ipsrcList[0][i]==attack_src_ip_arr[j]):
            print("right")
        if(ipsrcList[0][i]==attack_src_ip_arr[j] and ipdstList[0][j]==attack_dst_ip_arr):
            print("where")
            count_list[0][j]+=1
...
for i in range(len(ipsrcList[1])):
    for j in range(len(attack_dst_ip_arr)):
        ...
        if(ipsrcList[1][i]==attack_src_ip_arr[j] and ipdstList[1][j]==attack_dst_ip_arr):
            print("where")
            count_list[1][j]+=1
