...
cap = pyshark.FileCapture('pcap/s1-eth2_in.pcap', only_summaries=True)
cap = pyshark.FileCapture('pcap/s2-eth2_in.pcap', only_summaries=True)

cap = pyshark.FileCapture('pcap/s4-eth5_in.pcap', only_summaries=True)
cap = pyshark.FileCapture('pcap/s4-eth4_in.pcap', only_summaries=True)
cap = pyshark.FileCapture('pcap/s3-eth4_in.pcap', only_summaries=True)
cap = pyshark.FileCapture('pcap/s3-eth5_in.pcap', only_summaries=True)
